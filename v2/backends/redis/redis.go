...
import (
	...
	commonv1 "github.com/RichardKnop/machinery/v1/common"
...
func (b *Backend) SetStateSuccess(signature *tasks.Signature, results []interface{}) error {
